    ...
    b.append((
        ...
        (
            ...
            [
                ...
                ["LiDAR-inertial", "LiDAR + IMU", "iEKF or factor graph", "Pose + sparse map", "UAV, handheld SSL", f"Needs a structured cloud {cite('shan2020','xu2022fastlio')}"],
            ],
        ),
    ))
